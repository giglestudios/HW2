      ...
      if ((str.find_first_not_of(" \t\r\n") != string::npos) && (str[0] != '#')) {
          ...
          if (numused == numLights) // No more Lights 
            ...
            if (validinput) {
              ...
              // Those arrays can then be used in display too.  
                ...
                // since it is vec4 but here it is shown as GLfloat[] array of 4
                // So each light will have spacing of 4 units.
        ...
        // you can get a sense of how this works.  
          ...
          if (validinput) {
            ...
            mat4 rotateV = mat4(glm::transpose(Transform::rotate(values[3], axis)));
            rightmultiply(rotateV, transfstack);
          }
        }
